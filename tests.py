...
class TestStats(unittest.TestCase):
    ...
    def test_get(self):
        response_json = json.loads(self.b.Stats.get(
            dateFrom='2018-12-01',
            dateTo='2020-01-01',
...
class TestPurge(unittest.TestCase):
    ...
    def test_create(self):
        response_json = json.loads(self.b.Purge.create(
            url='https://myzone.b-cdn.net/style.css'))
        self.assertEqual(response_json['status_code'], 200)
...
class TestStorage(unittest.TestCase):
    ...
    def test_create(self):
        ...
        response_json = json.loads(self.b.Storage.create(
            name='example-a', main_storage_region='NY', replica_regions=['DE', 'SG', 'SYD']))
        self.assertEqual(response_json['status_code'], 201)
